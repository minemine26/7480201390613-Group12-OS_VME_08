...
def run_simulation():
    """Chạy mô phỏng chính"""
    try:
        from CODE.main import main as simulation_main
...
def run_gui():
    ...
    try:
        print("\n[INFO] Opening GUI...\n")
        from CODE.gui.main_window import main as gui_main
        gui_main()   # 🔥 chạy Tkinter GUI
    except Exception as e:
        print("[ERROR] GUI:", e)
...
def run_test_csv():
    ...
    try:
        ...
        # 🔥 Reload để tránh cache (rất quan trọng khi sửa file nhiều lần)
